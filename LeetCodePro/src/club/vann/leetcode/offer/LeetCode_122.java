...
//        return dp[len-1][0];
        ...
        // 0:不持有股票，可买；1:持有股票，可卖
        int dp_n_1_0 = 0;
        int dp_n_1_1 = -prices[0];
        for(int n = 1; n < len; n ++) {
            int dp_n_0 = Math.max(dp_n_1_1+prices[n], dp_n_1_0);
            int dp_n_1 = Math.max(dp_n_1_0-prices[n], dp_n_1_1);
            dp_n_1_0 = dp_n_0;
            dp_n_1_1 = dp_n_1;
        }
        return dp_n_1_0;
    ...
    static class TestCase {
        ...
        public static final int[] PRICES = {7,1,5,3,6,4};
