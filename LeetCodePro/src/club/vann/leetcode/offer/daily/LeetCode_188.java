...
public class LeetCode_188 {
    public static void main(String[] args) {
        ...
        System.out.println("Result["+TestCase.ANS+"] : " + leetCode.maxProfit2(TestCase.K, TestCase.PRICES));
        System.out.println("Result["+TestCase.ANS1+"] : " + leetCode.maxProfit2(TestCase.K1, TestCase.PRICES1));
        System.out.println("Result["+TestCase.ANS2+"] : " + leetCode.maxProfit2(TestCase.K2, TestCase.PRICES2));
        System.out.println("Result["+TestCase.ANS4+"] : " + leetCode.maxProfit2(TestCase.K4, TestCase.PRICES4));
        System.out.println("Result["+TestCase.ANS5+"] : " + leetCode.maxProfit2(TestCase.K5, TestCase.PRICES5));
        System.out.println("Result["+TestCase.ANS6+"] : " + leetCode.maxProfit2(TestCase.K6, TestCase.PRICES6));
    }
