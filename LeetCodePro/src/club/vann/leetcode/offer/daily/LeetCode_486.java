 ...
 * <p>难度：Medium</p>
 * <p>题目：预测赢家</p>
 * <p>描述：给定一个表示分数的非负整数数组。 玩家 1 从数组任意一端拿取一个分数，随后玩家 2 继续从剩余数组任意一端拿取分数，然后玩家 1 拿，…… 。每次一个玩家只能拿取一个分数，分数被拿取之后不再可取。直到没有剩余分数可取时游戏结束。最终获得分数总和最多的玩家获胜。
 *
...
public class LeetCode_486 {
    ...
    static class TestCase {
        ...
        public static int[] NUMS = {1, 5, 2};

        public static boolean ANS1 = true;
        public static int[] NUMS1 = {1, 5, 233, 7};
    }
}
