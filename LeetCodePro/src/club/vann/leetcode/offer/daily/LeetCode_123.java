...
public class LeetCode_123 {
    ...
    static class TestCase {
        ...
        public static int[] PRICES = {3,3,5,0,0,3,1,4};

        public static int ANS1 = 0;
        public static int[] PRICES1 = {3,3,5,0,0,3,1,4};

        public static int ANS2 = 0;
        public static int[] PRICES2 = {3,3,5,0,0,3,1,4};

        public static int ANS3 = 0;
        public static int[] PRICES3 = {3,3,5,0,0,3,1,4};
    }
}
